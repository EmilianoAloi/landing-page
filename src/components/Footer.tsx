            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-6 col-sm-2 py-4 ">
                        ...
                        <div className="d-flex flex-column gap-2 text-white-50 pt-3 ">
                            <a className="nav-link" target="_blank" rel="noopener noreferrer" href="https://portfolio-emilianoaloi.vercel.app/">Portfolio </a>
                            <a className="nav-link" target="_blank" rel="noopener noreferrer" href="https://github.com/EmilianoAloi">Github</a>
                            <a className="nav-link" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/emilianoaloi/">Linkedin</a>
                            <a className="nav-link" target="_blank" rel="noopener noreferrer" href="mailto:emilianoaloi.dev@gmail.com">Gmail</a>
                        </div>
                    </div>
                </div>
            </div>
